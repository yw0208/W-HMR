...
class DensePoseMethods:
    def __init__(self):
        #
        ALP_UV = loadmat(os.path.join('/opt/data/private/projects/PyMAF-smpl/data/UV_data', 'UV_Processed.mat'))
        ...
        self.Index_Symmetry_List = [1, 2, 4, 3, 6, 5, 8, 7, 10, 9, 12, 11, 14, 13, 16, 15, 18, 17, 20, 19, 22, 21, 24,
                                    23];
        UV_symmetry_filename = os.path.join('/opt/data/private/projects/PyMAF-smpl/data/UV_data', 'UV_symmetry_transforms.mat')
