...
from models.bert._gcnn import GraphResBlock
from models.bert.transformers.pytorch_transformers.modeling_bert import BertPreTrainedModel, BertEmbeddings, BertPooler, \
    BertIntermediate, BertOutput, BertSelfOutput
from models.bert.transformers.pytorch_transformers.modeling_utils import prune_linear_layer
    ...
    def MHA_GCN(self, hidden_states, attention_mask, head_mask=None,
        ...
        if self.has_graph_conv == True:
            if self.mesh_type == 'body':
                ...
                vertices = attention_output[:, :-1, :]
                img_tokens = attention_output[:, -1:, :]
