        ...
        if checkpoint_file is not None:
            ...
            for model in self.models_dict:
                if model in checkpoint:
                    ...
                    # k_v = {key: value for key, value in checkpoint['model'].items() if
                    #        key not in ['points_grid',
                    #                    'maf_extractor.0.conv2.weight', 'maf_extractor.0.conv2.bias',
                    #                    'maf_extractor.1.conv2.weight', 'maf_extractor.1.conv2.bias',
                    #                    'maf_extractor.2.conv2.weight', 'maf_extractor.2.conv2.bias',
                    #                    'regressor.0.fc1.weight','regressor.1.fc1.weight']}
                    # model_dict.update(k_v)
