...
class GraphConvolution(torch.nn.Module):
    ...
    def __init__(self, in_features, out_features, mesh='body', bias=True):
        ...
        if mesh=='body':
            adj_indices = torch.load('./data/smpl_431_adjmat_indices.pt')
            adj_mat_value = torch.load('./data/smpl_431_adjmat_values.pt')
            adj_mat_size = torch.load('./data/smpl_431_adjmat_size.pt')
        elif mesh=='hand':
            adj_indices = torch.load('./data/mano_195_adjmat_indices.pt')
            adj_mat_value = torch.load('./data/mano_195_adjmat_values.pt')
            adj_mat_size = torch.load('./data/mano_195_adjmat_size.pt')
