...
from models.ViTPose.mmpose.core.evaluation import (aggregate_scale, aggregate_stage_flip,
                                    flip_feature_maps, get_group_preds,
                                    split_ae_outputs)
from models.ViTPose.mmpose.core.post_processing.group import HeatmapParser
from models.ViTPose.mmpose.core.visualization import imshow_keypoints
from .. import builder
...
try:
    ...
    from models.ViTPose.mmpose.core import auto_fp16
