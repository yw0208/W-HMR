...
sys.path.append('.')
from demo.tester import SPECTester
...
CKPT = 'data/pretrained_model/w-hmr-p-vitpose_checkpoint.pt'
MIN_NUM_FRAMES = 0
...
def main(args):
    ...
    if demo_mode == 'video':
        ...
        output_img_folder = os.path.join(output_path, 'whmr_results')
    ...
    if args.mode == 'video':
        ...
        logger.info(f'W-HMR FPS: {fps:.2f}')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_folder', type=str, default='data/sample_images',
                        help='input image folder')

    parser.add_argument('--output_folder', type=str, default='output/sample_images',
