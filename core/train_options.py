...
class TrainOptions():
    def __init__(self):
        ...
        train.add_argument('--num_epochs', type=int, default=170, help='Total number of training epochs')
        train.add_argument('--regressor', type=str, choices=['hmr', 'pymaf_net'], default='pymaf_net',
                           help='Name of the SMPL regressor.')
        train.add_argument('--cfg_file', type=str, default='./configs/pymaf_config.yaml',
        ...
        train.add_argument('--CROP_PROB', type=float, default=0.3, help='Randomly crop image')
        train.add_argument('--OCC_AUG_DATASET', type=str, default='pascal', help='dataset used to augment')
        train.add_argument('--USE_SYNTHETIC_OCCLUSION', default=True, help='use occlusion augment')
        ...
        train.add_argument('--eval_dataset', type=str, default='h36m', help='Name of the evaluation dataset.')
