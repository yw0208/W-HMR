...
m = load_model('/home/yaowei/project/smpl/models/basicmodel_m_lbs_10_207_0_v1.0.0.pkl')

## Assign random pose and shape parameters
dataset=np.load('/home/yaowei/project/PyMAF-Tz-depth-bbox-full/demo/vis_img/agora_image.npz')
pose=dataset['pose'][0]
...
outmesh_path = './agora_smpl_vis.obj'
